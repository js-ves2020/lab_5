      ...
      <div className="latest container">
        <div className="content">
          ...
          <p>
            ...
            <br /> Voluptates, sequi labore eligendi voluptate assumenda
            repellendus
          </p>
        </div>
        <div className="row">
          <div className="col-sm-3">
            <div className="box">
              <img
                className="img-fluid"
                src="https://image.shutterstock.com/image-photo/young-female-participant-computer-course-260nw-464455418.jpg"
                alt=""
              />
              <div className="boxContent">
                ...
                <p>
                  Lorem ipsum dolor sit, amet consectetur adipisicing elit.
                  Debitis eligendi facere nesciunt at ab a excepturi ratione,
                  voluptatem tempora eveniet quod rerum doloribus accusantium
                  ex!
                </p><br/>
          ...
          <div className="col-sm-3">
            <div className="box">
              <img
                className="img-fluid"
                src="https://img.etimg.com/photo/92061190.cms"
                alt=""
              />
              <div className="boxContent">
          ...
          <div className="col-sm-3">
            <div className="box">
              <img
                className="img-fluid"
                src="https://www.mycomputercareer.edu/wp-content/uploads/2020/05/The-Guide-to-Information-Technology-and-Its-Role-During-COVID-19.jpg"
                alt=""
              />
              <div className="boxContent">
                <h6>Information Technolodgy</h6>
                <h5>20 principles</h5>
                <p>
                  Lorem ipsum dolor sit, amet consectetur adipisicing elit.
                  Debitis eligendi facere nesciunt at ab a excepturi ratione,
